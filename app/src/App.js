        ...
        <header className="bg-red-600 shadow-sm sticky top-0 z-50 text-[12px] -mx-4 sm:-mx-6 lg:-mx-16 xl:-mx-20">
          <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 min-w-0">
              ...
              <nav className="ml-4 flex items-center space-x-2 font-medium min-w-0 overflow-x-auto no-scrollbar whitespace-nowrap text-base">
          ...
          <div className="bg-white border-t border-gray-200">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
              ...
              <div className="ml-4 flex items-center space-x-3 text-gray-600 font-medium text-sm min-w-0 overflow-x-auto no-scrollbar whitespace-nowrap">
