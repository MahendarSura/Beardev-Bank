    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 py-8">
          {/*
            Home.tsx లో ఉన్న కంటెంట్ ఇప్పుడు ఇక్కడే ఉంది.
            ఇది సరైన పద్ధతి కాదు, కానీ మీరు అడిగినట్టుగా మార్చాను.
          */}
          <Routes>
            <Route path="/" element={
              <>
                {/* Hero Section */}
                <section className="relative h-[480px] md:h-[600px] bg-gradient-to-r from-[#E2001A] to-red-600 flex items-center px-10 text-white my-16 w-full rounded-lg shadow-lg">
                  <div className="w-full flex flex-col md:flex-row items-center gap-10">
                    <div className="max-w-3xl space-y-6">
                      ...
                      <div className="flex space-x-6">
                        <button className="bg-white text-[#E2001A] font-bold px-8 py-3 rounded hover:bg-gray-100 transition">Open an Account</button>
                        <button className="border-2 border-white text-white font-bold px-8 py-3 rounded hover:bg-white hover:text-[#E2001A] transition">Learn More</button>
                      </div>
                    </div>
                ...
                <section className="bg-white shadow rounded-md p-8 grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                  <div className="flex flex-col items-start hover:shadow-lg cursor-pointer transition p-6 border border-gray-100 rounded">
                    <div className="text-5xl mb-4 text-[#E2001A]">🏦</div>
                    <h3 className="text-2xl font-bold mb-2 text-[#E2001A]">Accounts</h3>
                    <p>Savings accounts, checking accounts, debit cards & more.</p>
                  </div>
                  <div className="flex flex-col items-start hover:shadow-lg cursor-pointer transition p-6 border border-gray-100 rounded">
                    <div className="text-5xl mb-4 text-[#E2001A]">💳</div>
                    <h3 className="text-2xl font-bold mb-2 text-[#E20000]">Credit Cards</h3>
                    <p>Credit cards with attractive rewards and benefits.</p>
                  </div>
                  <div className="flex flex-col items-start hover:shadow-lg cursor-pointer transition p-6 border border-gray-100 rounded">
                    <div className="text-5xl mb-4 text-[#E2001A]">💰</div>
                    <h3 className="text-2xl font-bold mb-2 text-[#E2001A]">Loans</h3>
                    <p>Home loans, personal loans, and car loans with competitive rates.</p>
                  </div>
                  <div className="flex flex-col items-start hover:shadow-lg cursor-pointer transition p-6 border border-gray-100 rounded">
                    <div className="text-5xl mb-4 text-[#E2001A]">📱</div>
                    <h3 className="text-2xl font-bold mb-2 text-[#E2001A]">Digital Banking</h3>
                ...
                <section className="bg-white shadow rounded-md p-10 my-16 w-full">
                  <div className="text-center space-y-8">
                    <h2 className="text-4xl font-extrabold text-[#E2001A]">Offers for You!</h2>
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-8">
                      <div className="rounded shadow hover:shadow-lg cursor-pointer overflow-hidden border border-gray-100">
                        ...
                        <div className="p-6 text-left">
                          <h3 className="text-2xl font-semibold mb-2 text-[#E2001A]">Zero Processing Fee on Home Loans</h3>
                      ...
                      <div className="rounded shadow hover:shadow-lg cursor-pointer overflow-hidden border border-gray-100">
                        ...
                        />
                        <div className="p-6 text-left">
                          <h3 className="text-2xl font-semibold mb-2 text-[#E2001A]">Earn More with Fixed Deposits</h3>
                      ...
                      <div className="rounded shadow hover:shadow-lg cursor-pointer overflow-hidden border border-gray-100">
                        ...
                        />
                        <div className="p-6 text-left">
                          <h3 className="text-2xl font-semibold mb-2 text-[#E2001A]">Instant Personal Loans</h3>
                ...
                <section className="bg-white shadow rounded-md p-10 my-16 w-full">
                  <div className="text-center space-y-10">
                    <h2 className="text-4xl font-extrabold text-[#E2001A]">What Our Customers Say</h2>
                    <div className="space-y-10">
                      <div className="bg-gray-50 p-8 rounded shadow max-w-xl mx-auto text-left border border-gray-200">
                        <div className="flex items-center mb-4 space-x-4">
                          ...
                          />
                          <h3 className="text-xl font-semibold text-[#E2001A]">Rajesh Kumar</h3>
                        </div>
                      ...
                      <div className="bg-gray-50 p-8 rounded shadow max-w-xl mx-auto text-left border border-gray-200">
                        <div className="flex items-center mb-4 space-x-4">
                          <img
                            ...
                            className="w-16 h-16 rounded-full object-cover"
                          />
                          <h3 className="text-xl font-semibold text-[#E2001A]">Sneha Patil</h3>
                        </div>
                        <p className="italic text-gray-900">
                      ...
                      <div className="bg-gray-50 p-8 rounded shadow max-w-xl mx-auto text-left border border-gray-200">
                        <div className="flex items-center mb-4 space-x-4">
                          <img
                            ...
                            className="w-16 h-16 rounded-full object-cover"
                          />
                          <h3 className="text-xl font-semibold text-[#E2001A]">Aditya Sharma</h3>
                        </div>
                        <p className="italic text-gray-900">
