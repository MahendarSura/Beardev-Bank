...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center font-sans">
      ...
      {/* HERO SECTION */}
      {/* This section now has its own centered container for better modularity */}
      ...
      {/* SERVICES SECTION */}
      <section className="bg-white shadow rounded-md p-8 grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto w-full">
      ...
      {/* OFFERS SECTION */}
      <section className="bg-white shadow rounded-md p-10 my-16 max-w-7xl mx-auto w-full">
